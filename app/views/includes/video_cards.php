        ...
        <div class="card-body d-flex align-content-center">
          <div class="row">
            ...
            <div class="col-9 py-auto my-auto">
              <p class="meta">
                <span class=""><span class="pr-2">by</span><a class="text-primary" href="<?php echo URLROOT; ?>/videos/index/<?php echo $video['channel_id']; ?>"><?php echo $video['channel_name']; ?></a></span>
              </p>
              <p class="meta">
